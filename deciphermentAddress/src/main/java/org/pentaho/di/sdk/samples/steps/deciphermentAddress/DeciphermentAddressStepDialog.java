...
public class DeciphermentAddressStepDialog extends BaseStepDialog implements StepDialogInterface {
    ...
    public DeciphermentAddressStepDialog(Shell parent, StepMetaInterface baseStepMeta, TransMeta transMeta, String stepname) {
        super(parent, baseStepMeta, transMeta, stepname);
        meta = (DeciphermentAddressStepMeta) baseStepMeta;
    }
