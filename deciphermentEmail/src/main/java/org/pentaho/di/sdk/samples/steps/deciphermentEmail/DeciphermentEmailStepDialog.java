...
public class DeciphermentEmailStepDialog extends BaseStepDialog implements StepDialogInterface {

    private static Class<?> PKG = DeciphermentEmailStepMeta.class;
    ...
    public DeciphermentEmailStepDialog(Shell parent, StepMetaInterface baseStepMeta, TransMeta transMeta, String stepname) {
        super(parent, baseStepMeta, transMeta, stepname);
        meta = (DeciphermentEmailStepMeta) baseStepMeta;
    }
