...
public class DeciphermentEmailStepMeta extends BaseStepMeta implements StepMetaInterface {
    private static Class<?> PKG =  DeciphermentEmailStepMeta.class;
    private String outputField = "Email";
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new DeciphermentEmailStepDialog(shell, meta, transMeta, name);
    }

    @Override
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
        return new DeciphermentEmailStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    /**
    ...
    public StepDataInterface getStepData() {
        return new DeciphermentEmailStepData();
    }
    /**
