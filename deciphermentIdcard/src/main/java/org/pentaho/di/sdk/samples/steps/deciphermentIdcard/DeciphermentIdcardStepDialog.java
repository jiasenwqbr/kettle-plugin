...
public class DeciphermentIdcardStepDialog extends BaseStepDialog implements StepDialogInterface {
    ...
    public DeciphermentIdcardStepDialog(Shell parent, StepMetaInterface baseStepMeta, TransMeta transMeta, String stepname) {
        super(parent, baseStepMeta, transMeta, stepname);
        meta = (DeciphermentIdcardStepMeta) baseStepMeta;
    }
