...
@Step(id = "DeciphermentIdcardStep", name = "身份证件号码脱敏脱密", description = "身份证件号码脱敏脱密", image = "org/pentaho/di/sdk/samples/steps/demo/resources/demo.svg")
public class DeciphermentIdcardStepMeta extends BaseStepMeta implements StepMetaInterface {
    private static Class<?> PKG =  DeciphermentIdcardStepMeta.class;
    private String outputField = "decipherment";
    private String inputField = "身份证号码";
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new DeciphermentIdcardStepDialog(shell, meta, transMeta, name);
    }

    @Override
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
        return new DeciphermentIdcardStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    /**
    ...
    public StepDataInterface getStepData() {
        return new DeciphermentIdcardStepData();
    }
    /**
