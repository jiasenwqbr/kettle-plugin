...
public class DeciphermentPhoneStepMeta extends BaseStepMeta implements StepMetaInterface {
    private static Class<?> PKG =  DeciphermentPhoneStepMeta.class;
    private String outputField = "手机号码";
    private String inputField = "手机号码";
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new DeciphermentPhoneStepDialog(shell, meta, transMeta, name);
    }

    @Override
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
        return new DeciphermentPhoneStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    /**
    ...
    public StepDataInterface getStepData() {
        return new DeciphermentPhoneStepData();
    }
    /**
