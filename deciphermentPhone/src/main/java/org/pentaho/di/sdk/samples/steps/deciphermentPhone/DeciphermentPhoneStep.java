...
public class DeciphermentPhoneStep extends BaseStep implements StepInterface {
    private DeciphermentPhoneStepData data;
     ...
     */
    public DeciphermentPhoneStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
    ...
    public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
        ...
        DeciphermentPhoneStepMeta meta = (DeciphermentPhoneStepMeta) smi;
        DeciphermentPhoneStepData data = (DeciphermentPhoneStepData) sdi;
    ...
    public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
        meta = (DeciphermentPhoneStepMeta) smi;
        data = (DeciphermentPhoneStepData) sdi;
        ...
        decipherment = decipherment.replaceAll("(\\w{3})\\w*(\\w{4})", "$1****$2");
