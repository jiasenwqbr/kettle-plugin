...
public class DeciphermentNameStepMeta extends BaseStepMeta implements StepMetaInterface {
    private static Class<?> PKG =  DeciphermentNameStepMeta.class;
    private String outputField = "姓名";
    private String inputField = "姓名";
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new DeciphermentNameStepDialog(shell, meta, transMeta, name);
    }

    @Override
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
        return new DeciphermentNameStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
    }
    /**
    ...
    public StepDataInterface getStepData() {
        return new DeciphermentNameStepData();
    }
    /**
