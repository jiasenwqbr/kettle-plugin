...
public class DeciphermentNameStepDialog extends BaseStepDialog implements StepDialogInterface {
    ...
    public DeciphermentNameStepDialog(Shell parent, StepMetaInterface baseStepMeta, TransMeta transMeta, String stepname) {
        super(parent, baseStepMeta, transMeta, stepname);
        meta = (DeciphermentNameStepMeta) baseStepMeta;
    }
